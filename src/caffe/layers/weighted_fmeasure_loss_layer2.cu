...
template <typename Dtype>
void WeightedFmeasureLoss2Layer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void WeightedFmeasureLoss2Layer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(WeightedFmeasureLoss2Layer);
